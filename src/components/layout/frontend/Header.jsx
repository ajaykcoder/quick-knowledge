...
const Header = () => {
    ...
    return (
        <div className="w-full bg-white pt-8 px-5 box-border">
            <div className="w-[1440px] max-w-full mx-auto box-border flex gap-x-4 items-center justify-between">
                ...
                <div className="w-60 flex gap-3 justify-end">
                    ...
                    <button onClick={handleDarkMode} className="text-base h-10 px-4 text-white bg-green hover:bg-darkGreen rounded flex items-center gap-x-1">
                        {darkMode ? (
